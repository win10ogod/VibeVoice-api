...
class VibeVoiceModel(VibeVoicePreTrainedModel):
    ...
    # Thread-local scheduler helpers for concurrent inference safety
    def set_thread_local_noise_scheduler(self, scheduler):
        self._tls.noise_scheduler = scheduler

    def clear_thread_local_noise_scheduler(self):
        if hasattr(self._tls, 'noise_scheduler'):
            delattr(self._tls, 'noise_scheduler')

    def get_thread_local_noise_scheduler(self):
        return getattr(self._tls, 'noise_scheduler', self.noise_scheduler)
